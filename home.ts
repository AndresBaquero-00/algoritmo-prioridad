...
const txtPrioridad: HTMLInputElement = document.querySelector('#prioridad');
// Contenedores
...
const crearProceso = (
    ...
    prioridad: number = parseInt(txtPrioridad.value)
): Proceso => {
...
const enviarProceso = (): void => {
    ...
    txtProceso.value = ''; txtLlegada.value = ''; txtRafaga.value = ''; txtPrioridad.value = ''
